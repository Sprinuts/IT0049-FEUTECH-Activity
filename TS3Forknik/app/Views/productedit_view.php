...
<div class="d-flex align-items-center justify-content-center">
    <div class="col col-md-6">
        <form action="<?= base_url('products/edit/'.$product['id']); ?>" method="post" class="adjust">
            ...
            <div class="form-group mb-2">
                ...
                <input type="text" name="purchaseprice" id="purchaseprice" class="form-control" value="<?= $product['purchaseprice']; ?>">
            </div>
            <div class="form-group mb-2">
                <label for="deliverydate" class="form-label">Delivery Date</label>
                <input type="datetime-local" name="deliverydate" id="deliverydate" class="form-control" value="<?= $product['deliverydate']; ?>">
            </div>
            <div class="form-group mb-2">
